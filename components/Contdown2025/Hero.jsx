  ...
  return (
    <section className="relative min-h-screen flex  md:items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <Image
          src="/PFC2025/Hero/hero-bg-mob.webp"
          alt="Futuristic space background"
          fill
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto pt-24 md:pt-0">
        ...
        <div className="flex flex-col gap-4 justify-center">
          <div className="text-center self-center text-white max-w-[80%] md:max-w-full">
            <h2 className=" text-[36px] md:text-[60px] text-shadow-lg font-[Manrope-Black] text-center text-[#fff] tracking-wide leading-[24px] md:leading-[44px]">
              31<sup className="text-xl align-top pt-[10px]">ST</sup> DECEMBER{" "}
              <span className="leading-[44px] md:leading-[44px]">2025</span>
            </h2>
          </div>
          {/* <p className="text-[25px] md:text-[32px] font-[Manrope-Bold]  text-shadow-lg text-[#fff] leading-[28px] md:leading-[33px] tracking-wide">
        RESORTS WORLD AWANA <br /> <span className='text-[30px] md:text-[38px]'>GENTING HIGHLANDS</span>
      </p> */}
        </div>
        <h1 className="text-md sm:text-md md:text-xl lg:text-2xl font-[Manrope-Bold]  text-[#FFD900] mb-4  mt-6  tracking-wide">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-4 ">
          <div className="bg-gradient-to-b from-[#022F87] via-[#011A4B]/50 to-transparent rounded-2xl p-4 sm:p-6 lg:p-8  min-w-[100px] sm:min-w-[120px] lg:min-w-[140px]">
            <div className="text-xl md:text-5xl font-[manrope] text-white mb-2">
              {timeLeft.days.toString().padStart(3, "0")}
            </div>
            <div className="text-yellow-400 text-sm sm:text-base lg:text-lg font-semibold tracking-wider">
              DAYS
            </div>
          </div>
          ...
          {/* <div className="bg-gradient-to-b from-[#022F87] via-[#011A4B]/50 to-transparent rounded-2xl p-4 sm:p-6 lg:p-8  min-w-[100px] sm:min-w-[120px] lg:min-w-[140px]">
            <div className="text-3xl sm:text-4xl lg:text-5xl font-[manrope] text-white mb-2">
        ...
        {/* Subtitle */}
        <p className="text-white text-[12px] md:text-[15px] font-[Manrope-Bold] mb-4 sm:mb-6 tracking">
          UNTIL WE LIGHT UP THE NIGHT AGAIN
        </p>

        {/* CTA Button */}

        <a href="#tickets" rel="noopener noreferrer">
          <button className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white text-[12px] md:text-[16px] font-[Manrope-Bold] md:font-[Manrope-Bold]  px-6 py-2 md:px-8 md:py-2 rounded-lg shadow-2xl transform hover:scale-105 transition-all duration-300 border-0">
            BUY TICKETS
          </button>
        </a>
      </div>
