...
<ul className='text_tnc_container  '>
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'>1. Data Collection</h2>
    ...
    <li className='flex flex-col gap-2'>
    <h2 className='tnc_text_header'>2. Information</h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'>3. Data Security</h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'> 4. Data Sharing </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'>5. Cookies and Tracking  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'>6. Third-party Links </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'>7. Changes to This Privacy Policy  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='tnc_text_header'>8. Contact Us  </h2>
