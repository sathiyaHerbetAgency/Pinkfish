      ...
      <div className="self-center">
        ...
        <div className="self-center flex flex-col md:flex-row justify-center md:items-center md:gap-11 gap-6 min-w-[80%]">
            ...
            <div className="flex flex-col md:justify-start gap-3">
              ...
              <button className="text-[16px] md:text-[20px] font-[Babas] font-[300] bg-[#FF0086] self-center md:self-start text-[#fff] w-fit rounded px-6 py-1" type='button'>contact us</button>
            </div>
        </div>
