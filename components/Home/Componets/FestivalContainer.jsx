...
const FestivalContainer = ({data,index,active}) => {
    ...
    const overlayContainerMobOpacity='  absolute z-1 w-[90vw] min-h-[464px] flex flex-col justify-between pb-5 bg-gradinet-gray';
  ...
  return (
    ...
    <div className="md:hidden flex flex-col ">
        <div  className="w-[90vw] h-[424px]    self-center">
            {active===index&&(
                ...
                <img src={data.imgUrl} className="w-[90vw] h-[464px] object-cover" alt="slider-1" />
            </div>
            </div>
    </>
  )
