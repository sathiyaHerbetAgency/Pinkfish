...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col max-w-[100vw]">
        <div className="max-w-[100vw] h-[75vh]  md:px-0   self-center flex gap-3  ">
          ...
          >
            <SwiperSlide>
              <SlideImage url={"./Home/Hero/slide1-home.webp"} urlMob={"./Home/Hero/slide1-home-mob.webp"} year="2024" link="#" slide={0} />
            </SwiperSlide>
            <SwiperSlide>
            <SlideImage url={"./Home/Hero/slide2-home.webp"} urlMob={"./Home/Hero/slide1-home-mob.webp"} year="2024" link="#"  slide={1}  />
            </SwiperSlide>
          </Swiper>
