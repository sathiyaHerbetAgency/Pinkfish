...
const Faq = () => {
  ...
  <p className="world_text   leading-relaxed" >Pinkfish celebrates the best of dance, urban pop, and live music acts, all in one place. With a lineup of top-notch performers and artists, Pinkfish promises to be an unforgettable experience for music and art lovers alike. Whether you're a die-hard fan of your favourite performers or simply looking for a night of non-stop fun and entertainment, Pinkfish has something for everyone. It's more than just a festival - it's a celebration of creativity, expression, and community. Come and experience music, dance and art in new and exciting ways.</p>
    ...
    const data4=<p className="world_text py-3  leading-relaxed" >We welcome vendors and sponsors to join our festivals. Drop us an email at <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" target="_blank" href="mailto:info@pinkfishfestival.com" >info@pinkfishfestival.com</a> for more information on the application process and the benefits of collaborating with us!</p>
    const data5=<p className="world_text py-3  leading-relaxed" >You can grab our merchandise online at  <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" target="_blank" href="https://pinkfishfestival.com/merchandise" >https://pinkfishfestival.com/merchandise</a> or directly at our festivals. Explore our range of apparel, accessories, and unique memorabilia.</p>
    const data6=<p className="world_text py-3  leading-relaxed" >We love to hear your feedback and suggestions! Drop us an email at info@pinkfishfestival.com or contact us directly to share your thoughts and help us make things even better!</p>
    const data7=<p className="world_text py-3  leading-relaxed" >Yes, we are always on the lookout for passionate and creative individuals to join our team. Email us at <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" target="_blank" href="mailto:marketing@pinkfishfestival.com" >marketing@pinkfishfestival.com</a> and let’s chat!</p>
    const data8=<p className="world_text py-3  leading-relaxed" >For more details or questions, kindly email us at <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="mailto:info@pinkfishfestival.com" >info@pinkfishfestival.com.</a></p>
