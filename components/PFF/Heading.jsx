...
const Heading = ({ text, page, description }) => {
  return (
    <div className="flex flex-col max-w-[900px]  md:py-11 py-8 self-center gap-3">
        ...
        {page === "PFF" ? (
          ...
          >
            <g clipPath="url(#clip0_39_317)">
              <path
                d="M46.9653 48.0064L19.4256 6.25122L6.48499e-05 49L46.9653 48.0064Z"
                fill="white"
              />
              <path
                d="M63 26.4995L45.5237 0L33.1954 27.1288L63 26.4995Z"
                fill="white"
              />
            </g>
            <defs>
        ...
        {page === "PFF" ? (
          ...
          >
            <g clipPath="url(#clip0_39_322)">
              <path
                d="M16.0347 48.0064L43.5744 6.25122L62.9999 49L16.0347 48.0064Z"
                fill="white"
              />
              <path
                d="M0 26.4995L17.4763 0L29.8046 27.1288L0 26.4995Z"
                fill="white"
              />
            </g>
            <defs>
      ...
      <p className="text-white font-[manrope] md:text-[16px] text-[12px] leading-[18px]  text-center">
        {description}
      </p>
    </div>
  );
