...
const Hero = ({ select }) => {
  ...
  const textHero =
    "text-[12px] md:text-[16px] font-[DmSansLight] md:leading-[20.83px] leading-[15.62px] font-light text-center text-[#fff] md:w-[80%] self-center";
  const textHeadingBtn =
    "text-[16px] md:text-[16px] font-[manrope] md:leading-[20.83px] leading-[20.83px] font-bold text-center text-[#fff] uppercase";
          ...
          <div className="flex flex-col">
            <div className=" text-left md:text-center flex justify-center w-[80%] md:w-[100%] self-center gap-6 ">
              ...
              <button
                type="button"
                href="/faq"
                className=" bg-[#F33288] uppercase text-[16px] leading-[24px] font-[manrope] font-bold text-white w-[71px] h-[48px]  rounded-md "
              >
                <a href="/Faq">FAQ</a>
              </button>
            </div>
      ...
      <div className="flex flex-col  min-w-[100vw]">
        <div className="md:hidden  flex flex-col gap-6 justify-center self-center min-w-[100vw] ">
          <div className="w-[90%] h-[103px] bg-[#FFFFFF1A] flex flex-col self-center justify-center  gap-2 text-white ">
            <p className={textHeadingBtn}>{checkContents().ticketHeading}</p>
            <a
              href={checkContents().link}
              className=" bg-[#F33288]  text-[12px] leading-[14px] font-[manrope] font-bold text-white px-6 h-[32px] w-[200px] flex justify-center items-center rounded-md  self-center"
            >
              {checkContents().button_text}
            </a>
            <a
              type="button"
              href="/faq"
              className=" bg-[#F33288]  text-[12px] leading-[14px] font-[manrope] font-bold text-white  h-[32px] w-[200px] rounded-md  self-center flex justify-center items-center"
            >
              Faq
            </a>
          </div>
          <div className="w-[90%] h-[103px] bg-[#FFFFFF1A] flex flex-col self-center justify-center gap-2  text-white  ">
            ...
            type="button"
            href="/faq"
            className=" bg-[#F33288]  text-[12px] leading-[14px] font-[manrope] font-bold text-white w-[92px] h-[32px] rounded-md  self-center flex justify-center items-center"
          >
           Faq
           </a> */}
          </div>
