...
const GalleryContainer = () => {
    ...
    const imageSmall="w-[353.6px] h-[280px] md:w-[220px] lg:w-[291px] md:h-[185px] lg:h-[280px]"
    const mobData=[
        {
    ...
    <div className="hidden md:block">
        <div className="flex flex-col md:gap-5 lg:gap-6 max-w-1100px">
            <div className="self-center ">
                <Link href="/pff2024-gallery" className="absolute z-1 md:w-[670px] lg:w-[925px] md:h-[200px] lg:h-[300px] flex flex-col justify-end">
                    <p className={textGallery}>Pinkfish Music & Arts Festival 2024</p>
                </Link>
                <img src="2024Gallery/pff_gallery.webp" className="md:w-[700px] lg:w-[925px] md:h-[220px] lg:min-h-[300px]" alt="pff 2024" /> 
            </div>
            <div className="flex self-center md:gap-5 lg:gap-6">
                <Link href="/pfc2023-gallery" className="">
                    ...
                    <img className={imageSmall} src="2024Gallery/pfc_gallery.webp" alt="pfc gallery" /> 
                </Link>
                <Link href= "/pfl-tyga-gallery" className="">
                    <div className={overlayContainer}>
                        <p className={textGallery1}>Pinkfish Live: Tyga</p>
                    </div>
                    <img className={imageSmall} src="2024Gallery/pfl_gallery.webp" alt="pfl gallery" />
                </Link>
                <Link href="/pff2023-gallery" className="">
                    <div className={overlayContainer}>
                        <p className={textGallery1}>Pinkfish Music & Arts Festival 2023</p>
                    </div>
                    <img className={imageSmall} src="2024Gallery/pff_2023_gallery.webp" alt="pff 2023" />
                </Link> 
            </div>
        </div>
    </div>
