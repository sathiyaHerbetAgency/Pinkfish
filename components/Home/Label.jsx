  ...
  return (
    <>
      <div
        ...
        className={`${
          color === "pink"
            ? "horizantal_pink_container_live_pff "
            : "horizantal_gray_container_live_pff "
        } `}
      >
