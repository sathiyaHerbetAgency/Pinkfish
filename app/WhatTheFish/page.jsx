  ...
  return (
    ...
    <div className="contact_main_container_what flex flex-col justify-center pd:mb-0 pb-6      ">
         ...
         <div className='flex flex-col gap-6    '>
           ...
           The 
           <img src='/fish.svg' className='w-[62.33px] h-[26.15px]' alt='fish'/> !
           
           </div>
           <div className='flex flex-col gap-6 md:w-[50%] self-center'>
                    <h2 className='contact_sub_text text-start md:text-center'>Pinkfish celebrates the best of dance, urban pop, and live music acts, 
                    ...
                    <h2 className='contact_sub_text  text-start md:text-center'>Whether you're a die-hard fan of your favourite performers or simply looking for a night of non-stop fun and entertainment, Pinkfish has
                    ...
                    ways.</h2>
                    <h2 className='contact_sub_text  text-start md:text-center'>  Let Pinkfish be your way of life!</h2>
                    </div>
         </div>
         </div>
         </div>
