...
const HeadingClass =
  "text-[#90FF7E] text-center md:text-left self-center text-[28px] md:text-[36px] leading-[34.13px] md:leading-[43.88px] font-[Manrope-Bold] uppercase";
const HeadingClass2 = `${HeadingClass} text-white`;
const DescriptionClass =
  "text-white self-center text-center md:text-left text-[16px] leading-[19.5px] font-[manrope] md:w-[464px] self-start";
const BuyBtnClass =
  "bg-[#90FF7E] text-[#000] flex justify-center items-center  rounded text-[20px] w-[192px]   md:w-[195px] h-[45px] leading-[24px] font-[marope] uppercase";
        ...
        <div className=" lg-[400px] xl:w-1/2 order-2 md:order-1 flex flex-col items-center md:items-start gap-6 md:gap-3   w-[90%]">
          ...
          <div className="">
            <p className={DescriptionClass}>
              {artistData.offerSectionTextPart1}
            </p>
          </div>
