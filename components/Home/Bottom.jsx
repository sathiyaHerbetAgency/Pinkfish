...
const Bottom = () => {
  return (
    <div className="flex flex-col bg-gallery-home py-24 pt-32">
      <div className="bg-black flex flex-col gap-6 self-center max-w-[800px] min-w-[70%] py-24 rounded-2xl">
        <div className="w-[80%] flex gap-6 self-center">
          <div className=" basis-1/2 self-center  ">
            <div className="flex flex-col gap-6 justify-between">
              <div className="  ">
                <h1 className="world_header_home text-[40px] leading-[50px] ">
                  Ride on the rhythm of life
                </h1>
              </div>
              <div className=" items-center self-center  gap-11">
          ...
          <div className=" basis-1/2 flex flex-col logo_container md:mt-0 mt-11  ">
