...
<Link href="/" className="menu_text_mob_live" arial-label="Home" onClick={()=>setToggleDropdown(false)}>Home </Link>
    ...
    <Link href="/Live/Contact" className='flex items-center' arial-label="Contact Page"  onClick={()=>setToggleDropdown(false)}>
        <button className="buy_ticket_live mb-6 flex " aria-label="Reach out" type="button">Reach out
