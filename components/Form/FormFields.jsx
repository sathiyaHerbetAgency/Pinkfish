...
const FormFields = () => {
  const text =
    "text-white text-[14px] leading-[24px] md:text-[14px] md:leading-[24.66px] font-[manrope] font-[400] ";
  const textSmall =
    "text-white text-[8px] leading-[14px] italic md:text-[11px] md:leading-[14px] pt-2 font-[manrope] font-[400] ";
  const heading =
    "hero-shadow hidden md:block text-white text-[28px] leading-[36.66px] md:text-[36px] md:leading-[36.66px] font-[manrope] font-[800] mb-6  text-center uppercase ";
  const heading1 =
    "hero-shadow1  md:hidden text-white text-[28px] leading-[36.66px] md:text-[36px] md:leading-[36.66px] font-[manrope] font-[800] mb-6  text-center uppercase ";
  ...
  const urlForm =
    "https://script.google.com/macros/s/AKfycbwkMdM2su79hkYKcopWBAcJu2t_C0kmqNcMSojCIXEYgfMWCLOtnVOPz8R0trFplogZ/exec";
      ...
      <div className="flex flex-col justify-center w-[100%] md:h-[620px] my-6 md:my-0 ">
        ...
        >
          <input
            name="Name"
            required
            className="bg-white rounded-md text-black p-2 pl-6 w-full font-[manrope]"
            type="text"
            placeholder="Name"
          />
          <input
            name="Phone"
            required
            className="bg-white rounded-md text-black p-2 pl-6"
            type="tel"
          ...
          <input
            name="Email"
            required
            className="bg-white rounded-md text-black p-2 pl-6 w-full"
            type="text"
            placeholder="Email"
          />
          ...
          <div class="relative">
            ...
            <p className={textSmall}>
              *Champagne and Beer will be provided in the agreed quantities
              based on the selected package.
            </p>
            <p className={textSmall}>
              *Beverage brands are subject to change without prior notice.
            </p>
        ...
        <div ref={popupContainerRef} className="popup-container">
          {loading ? (
            <div className="popup-card">
              <img
                className="w-[100px] h-[50px] self-center"
                src="./Svg/spinner-form.svg"
                alt=""
              />{" "}
            </div>
          ) : (
