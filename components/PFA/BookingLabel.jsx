      ...
      <div className="self-center flex justify-center">
        ...
        <div className="self-center flex flex-col md:flex-row justify-center md:items-center md:gap-11 gap-6 min-w-[80%]">
            <div className="flex flex-col gap-0">
              <h2 className="text-[30px] md:text-[48px] leading-[32px] md:leading-[50px] font-[Babas] font-[300] text-center md:text-left  text-[#fff]">Book VVIP Sofa:</h2>
              <h2 className="text-[30px] md:text-[48px] leading-[32px] md:leading-[50px]  font-[Babas] font-[300] text-center md:text-left  text-[#fff]">The VVIP Experience Now</h2>
            </div>
            <div className="flex flex-col md:justify-start gap-3">
              <h2 className="text-[16px]  md:text-[20px] leading-[16px] md:leading-[20px] font-[Babas] font-[300]   text-center md:text-left  text-[#fff]">email: info@pinkfishfestival.com</h2>
              <h2 className="text-[16px] md:text-[20px]  leading-[16px] md:leading-[20px] font-[Babas] font-[300]   text-center md:text-left text-[#fff]">contact: +6012-2655783</h2>
