...
const GalleryContainer = () => {
  ...
  const overlayContainerbottom =
    " absolute z-1 w-[48%] h-[177px] md:w-[200px] lg:w-[340px] md:h-[185px] lg:h-[276px] flex flex-col justify-center ";
  const overlayContainerbottomLast =
    " absolute z-1 w-[52%] h-[177px] md:w-[200px] lg:w-[354px] md:h-[185px] lg:h-[276px] flex flex-col justify-center ";

  const imageSmall =
    "w-[100vw] h-[217px] md:w-[200px] lg:w-[340px] md:h-[185px] lg:h-[276px]";
  const imageSmallLast =
    "w-full h-[177px] md:w-[200px] lg:w-[354px] md:h-[185px] lg:h-[276px]";
  const imageSmallTop =
    "w-full h-[177px] md:w-[400px] lg:w-[694px] md:h-[220px] lg:h-[337px]";
      ...
      <div className="hidden md:block ">
        ...
        <div className="flex justify-center max-w-1176px ">
          ...
          <div className="self-center ">
            <Link
              href="/pfc2023-gallery"
              className="absolute z-1 w-[482px] h-[613px] flex flex-col justify-center"
            >
              <p className={textGallery}>Pinkfish Countdown 2023</p>
            </Link>
            <img
              src="./Home/GalleryContainer/gal-1.webp"
              className="w-[482px] h-[613px]"
              alt="pff 2024"
            />
          </div>
          <div className="flex flex-col self-center">
            <div className="flex flex-col">
              <Link href="/pff2024-gallery" className={overlayContainer}>
                <p className={textGallery1}>
                  Pinkfish Music & Arts Festival 2024
                </p>
              </Link>
              <img
                className={imageSmallTop}
                src="./Home/GalleryContainer/gal-2.webp"
                alt="pfc gallery"
              />
            </div>
            ...
            <div className="flex">
              <div className="flex flex-col">
                <Link
                  href="/pff2023-gallery"
                  className={overlayContainerbottom}
                >
                  <p className={textGallery2}>
                    Pinkfish Music & Arts Festival 2023
                  </p>
                </Link>
                <img
                  className={imageSmall}
                  src="./Home/GalleryContainer/gal-3.webp"
                  alt="pfl gallery"
                />
              </div>
              <div className="flex flex-col">
                <Link
                  href="/pfl-tyga-gallery"
                  className={overlayContainerbottom}
                >
                  <p className={textGallery2}>Pinkfish Live: Tyga </p>
                </Link>
                <img
                  className={imageSmallLast}
                  src="./Home/GalleryContainer/gal-4.webp"
                  alt="pff 2023"
                />
              </div>
            </div>
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="flex  self-center ">
          <div className="">
            ...
            <img
              className={imageSmallLast}
              src={mobData1[0].imgUrl}
              alt="pfl gallery"
            />
          </div>
          <div className="">
            <Link
              href={mobData1[1].link}
              className={overlayContainerbottomLast}
            >
              <p className={textGallery1Bottom}>{mobData1[1].text}</p>
            </Link>
            <img
              className={imageSmallTop}
              src={mobData1[1].imgUrl}
              alt="pfc gallery"
            />
          </div>
        </div>
