...
const Gallery = ({select}) => {
  ...
  useEffect(() => {
    ...
    const imageSets = {
      ...
      pff_mob: ["pfp_1", "pfp_2", "pfp_3", "pfp_4", "pfp_5", "pfp_6", "pfp_7", "pfp_8", "pfp_9", "pfp_10", "pfp_11", "pfp_12","pfp_13","pfp_14"],
    };
      ...
      >
       {imageSets["pff_mob"].map((file, index) => (
                ...
                <a
                  ...
                  className=""
                >
                  <img src={`./pfp/Gallery/Mini/${file}.webp`} className="w-[100%] h-[100%] pb-1 md:pb-2" alt={`Arts festival ${index + 1} `} />
                </a>
