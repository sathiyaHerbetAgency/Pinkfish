      ...
      <div className="self-center flex flex-col ">
        ...
        <div className="bg-banner-boris w-[90vw] md:w-[600px] h-[140px] md:h-[250px] flex flex-grow mt-12">
          <div className=" relative max-w-[40px] md:max-w-[70px] grow h-[140px] md:h-[250px] flex justify-center items-center ">
            <p
              className="
          text-white text-[8px]  md:text-[14px] font-[Archivo] font-light md:font-[400]  uppercase min-w-[140px] text-center md:min-w-[250px]  transform -rotate-90"
            >
              PREMIUM ADMISSION
            </p>
          </div>
          <div className=" p-3 md:p-6 md:pl-8 rounded-md max-w-xs my-auto text-left">
            {/* Large VVIP text */}
            <h2 className=" text-[24px] md:text-[64px]   uppercase font-[Archivo] font-[900] text-white">
              VVIP
            </h2>

            {/* Subheading */}
            <p className="text-[#FFC4E4] text-[12px] md:text-[20px] mt-2 font-[Archivo] font-[400] uppercase">
            ...
            <a
              ...
              className="inline-block bg-pink-500 text-white font-[Archivo] font-[300] text-[12px] md:text-[16.82px] w-[150px] md:w-[250px] text-center py-2 md:py-4 mt-2 md:mt-4  rounded-md uppercase"
            >
              +6012 265 5783
            </a>
          </div>
