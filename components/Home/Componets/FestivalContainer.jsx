...
const button="bg-[#2A2A2A] text-white text-[8px] md:text-[12.31px] leading-[10px] md:leading-[24.63px] font-[Sofia] font-[800] p-2 px-3 mt-3 mr-3 md:mr-0 rounded-md uppercase"
