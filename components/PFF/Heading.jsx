...
return(
    <div className="flex md:gap-8 justify-center items-center self-center max-w-[900px] md:py-11 py-8  gap-3 ">
        {page==="PFF"?
        ...
        <h1 className="text-white font-bold font-[Integral] md:text-[36px] text-[14px] leading-[20px] uppercase text-center">{text}</h1>
        {page==="PFF"?
