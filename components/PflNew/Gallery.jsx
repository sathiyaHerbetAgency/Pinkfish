...
const Gallery = ({select}) => {
  ...
  useEffect(() => {
    ...
    const imageSets = {
      ...
      pff_mob: ["gallery_1", "gallery_2", "gallery_3", "gallery_4", "gallery_5", "gallery_6", "gallery_7", "gallery_8", "gallery_9", "gallery_10", "gallery_11", "gallery_12"],
    };
  ...
  return (
    ...
    <div className="flex self-center gap-3 justiyfy-center">
      ...
      <div className={button1}>2023</div>
      ...
      >
       {imageSets["pff_mob"].map((file, index) => (
                ...
                <a
                  href={`./pfl_new/2023Gallery/FullImage/${file}.webp`}
                  key={"my-test-gallery" + '-' + index}
                  target="_blank"
                  rel="noreferrer"
                  className=""
                >
                  <img src={`./pfl_new/2023Gallery/${file}.webp`} className="w-[100%] h-[100%] pb-1 md:pb-2" alt={`Arts festival ${index + 1} `} />
                </a>
