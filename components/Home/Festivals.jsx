          ...
          <div className="  w-[100%] self-center z-10 pl-24">
            ...
            <div className="  flex flex-col justify-end md:justify-center items-center justify-items-center h-[420px]   absolute  ">
              <div className="flex justify-between w-[88vw]">
                <button
                  onClick={handlePrev}
                  className=" bg-[#000000A0] rounded-[100%] w-[80px] h-[80px] flex justify-center items-center  z-[2] ml-10 md:-ml-8"
                >
                  <img
                    src="./Home/Festival/Icons/left-arrow.png"
                    className="w-[64px]"
                    alt="arrow"
                  />
                </button>
                <button
                  onClick={handleNext}
                  className=" bg-[#000000A0] rounded-[100%] w-[80px] h-[80px] flex justify-center items-center  z-[2] "
                >
                  <img
                    src="./Home/Festival/Icons/right-arrow.png"
                    className="w-[64px]"
                    alt="arrow"
                  />
                </button>
                ...
                >
                  {slideData.map((each, index) => (
                    <SwiperSlide
                      className={`${
                        index === 0 && "ml-20"
                      }text-white max-w-[370px] h-[394px]`}
                    >
                      <FestivalContainer
        ...
        <div className="flex flex-col gap-3 self-center">
          ...
          <div className="  flex flex-col justify-center items-center justify-items-center h-[350px] min-w-[100vw]   absolute  ">
            <div className="flex justify-between self-center w-[90vw]">
              <button
                onClick={handlePrev1}
                className=" bg-[#000000A0] rounded-[100%] w-[40px] h-[40px] flex justify-center items-center  z-[2] "
              >
                <img
                  src="./Home/Festival/Icons/left-arrow.png"
                  className="w-[34px]"
          ...
          >
            {slideData.map((each, index) => (
              <SwiperSlide
                ...
                className="flex flex-col  text-white max-w-[60vw] h-[300px] justify-items-center self-center mb-3"
              >
                <FestivalContainer
                  setShowPopup={setShowPopup}
                  data={each}
