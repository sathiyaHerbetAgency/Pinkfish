...
<ul className='text_tnc_container_live '>
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>1. Ticketing and Entry </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>2. Age Restrictions  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>3. Event Rules and Conduct  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'> 4. Security and Safety  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>5. Ticket Refunds and Exchanges </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'> 6. Event Schedule and Lineup </h2>
        <p className='tnc_text_live'>6.1. The event schedule, lineup, and artist performances are subject to change without notice.  </p>
    </li>
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>7. Photography and Videography  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>8. Lost or Stolen Items  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>9. Health and Medical</h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>10. Weather  </h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>11. Liability and Release</h2>
    ...
    <li className='flex flex-col gap-2'>
        <h2 className='.tnc_text_header_live'>12. Termination  </h2>
