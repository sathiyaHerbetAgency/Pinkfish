...
const Popup = ({ setShowPopup }) => {
  ...
  const button =
    "text-[12px] text-white md:text-[16px] leading-[22.66px] md:leading-[22.66px] font-[manrope] font-[400] p-2 px-4  bg-[#FF0086] rounded w-[110px]";
              ...
              <div>
                ...
                <div className="flex flex-col justify-end ">
                  <div className="flex self-center  gap-3 justify-center">
                    <a
                      href="https://www.ticket2u.com.my/event/45513_91cb3c62451045c481abbbe0076fd36f"
                      target="_blank"
                    ...
                    <a
                      href="https://www.ticket2u.com.my/event/45515_637ac61b2643476ea93de8d6ea671318"
                      target="_blank"
                      className="w-fit self-center flex justify-start mt-3"
                    >
                      <button className={button} alt="button">
            ...
            <div className="flex flex-col   pb-4 justify-end ">
              <div className="flex self-center gap-3 justify-center w-[100vw]">
                <a
                  href="https://www.ticket2u.com.my/event/45513_91cb3c62451045c481abbbe0076fd36f"
                  target="_blank"
                  className="w-[100px] self-center flex justify-start "
                >
                  <button className={button} alt="button">
                    BUY NOW
                  </button>
                ...
                <a
                  href="https://www.ticket2u.com.my/event/45515_637ac61b2643476ea93de8d6ea671318"
                  target="_blank"
                  className="w-fit self-center flex justify-start"
                >
                  <button className={button} alt="button">
                    BNPL
                  </button>
