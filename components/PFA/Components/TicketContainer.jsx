      ...
      <div className="flex flex-col gap-6 w-[160px] md:w-[220px] relative overflow-hidden">
        <div className={`flex flex-col ${Ticket.TicketStatus ? "ticket-body-bg" : "ticket-body-bg"} justify-start h-[190px] md:h-[240px] gap-0 w-full`}>
          <div className="flex flex-col justify-around min-h-[80%] md:min-h-[70%]">
            <h2 className="text-[10px] w-[100%] text-center md:text-[12px] font-[100] font-[Integral] text-[#fff] uppercase">
              {Ticket.title}
            </h2>
            <div>
              <h2 className="text-[16px] md:text-[18px] tracking-[1px] font-[Integral] text-center text-[#fff] uppercase">
                {Ticket.type}
              </h2>
        ...
        {Ticket.BuyButtonStatus && (
          <Link
            href={Ticket.link1}
            target="_blank"
            className={`uppercase rounded py-2 md:py-3 font-[Integral] text-[14px] text-center min-w-[100%] ${
