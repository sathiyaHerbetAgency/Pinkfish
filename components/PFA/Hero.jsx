...
const Hero = () => {
  ...
  return (
    <div className={` flex flex-col justify-between  pt-4 bg-black }`}>
        <div className="flex flex-col gap-4  self-center">
            <div className=" flex flex-col self-center  gap-4">
                <img src="./PFA/pf_arena_logo.png"  className="w-48 self-center" alt="pf_arena_logo" />        <div className="flex justify-center">

                <div className="flex flex-col justify-center align-center">
                <p className="text-[16px] md:text-[24px] font-[Integral] pb-2 font-[700] text-[#fff] text-start uppercase hidden md:block">{PFA.first_heading}</p>
            ...
            <div className="min-w-[100%] flex md:flex-row flex-col justify-center py-3">
                <div className="flex flex-col items-center align-center">
                    ...
                    <p className="text-[12px] md:text-[16px] font-[Integral] pb-2 font-[300] text-[#fff] text-start uppercase hidden md:block">{PFA.text1}</p>
                </div>
