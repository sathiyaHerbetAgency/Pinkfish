...
const EventContainer = ({ link, title, description }) => {
  ...
  return (
    <a
      href={link}
      arial-label={link}
      className={` md:min-w-[300px] h-[80px] md:h-[120px] ${checkContents()} rounded-2xl flex flex-col  justify-center border md:border-none text-white`}
    >
      <div className="flex flex-col justify-center ">
        <div className="self-center w-[90%] flex justify-between">
          ...
          <button className="cursor-pointer">
            ...
            >
              <path
                d="M12.9328 7.40717L7.2335 1.54526L8.73588 0L17 8.5L8.73588 17L7.2335 15.4547L12.9328 9.59283H0V7.40717H12.9328Z"
                fill="white"
              />
            </svg>
          </button>
