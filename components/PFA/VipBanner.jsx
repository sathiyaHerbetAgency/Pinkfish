      ...
      <div className="flex justify-center">
        <div className="vip-banner flex flex-col justify-center min-h-[235px]  self-center">
            <div className="flex  gap-4 self-center w-[80%]">
              <div className="flex flex-col justify-around items-center  gap-6 h-full   border-r-2 border-[#fff]">
              ...
              <div className="flex flex-col justify-around items-center max-w-fit   border-r-2 border-[#fff]">
               ...
               <div className="flex flex-col  justify-around items-center w-fit h-full  ">
