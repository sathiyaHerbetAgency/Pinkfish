  ...
  return (
    ...
    <div className="flex flex-col gap-4  self-center">
        ...
        <div className="min-w-[100vw] flex md:flex-row flex-col justify-center bg-[#FF0086] py-3">
            <h1 className="text-[16px] md:text-[24px] font-[Integral] pb-2 font-[700] text-[#fff] text-start uppercase hidden md:block">{PFA.text}</h1>
            <h1 className="text-[14px] md:text-[24px] leading-[16px] font-[Integral] pb-2  font-[700] text-[#fff] text-center uppercase md:hidden">{PFA.text_mob1}</h1>
            <h1 className="text-[14px] md:text-[24px] leading-[16px] font-[Integral] pb-2 font-[700] text-[#fff] text-center uppercase md:hidden">{PFA.text_mob2}</h1>
