...
const Hero = () => {
  ...
  return (
    <div className="">
      <video src="/bg_video_1.mp4" ref={(el)=>firstRef=el} className='min-h-[80vh] md:h-[95vh] min-w-[100vw]  object-cover absolute hero_container_new' id='videos' autoPlay loop playsInline muted ></video>
        <div className={` flex flex-col md:justify-end gap-11 justify-around min-h-[80vh] md:h-[95vh] bg-new-hero z-[50] relative`}>
